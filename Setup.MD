...
> _Note_ you can accomplish all of these steps from within [Visual Studio Code](https://code.visualstudio.com/) by to _Terminal_ then selecting _New Terminal_.  
